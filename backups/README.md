...
1. **`warsgate_backup_latest.json`** (และไฟล์ตามวันที่ `warsgate_backup_2026-09-21.json`)
...
2. **`warsgate_accounting_backup_latest.xlsx`** (และไฟล์ตามวันที่ `warsgate_accounting_backup_2026-09-21.xlsx`)
...
---
*สร้างอัตโนมัติเมื่อ: 2026-09-21T08:39:49+07:00 โดย WARSGATE Accounting Backup Utility*
